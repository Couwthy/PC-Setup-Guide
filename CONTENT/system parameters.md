...
### The result of applying a regular file includes the following improvements:

- The distribution of background and active processes will be optimized, which can improve system performance and reduce time delays. System power consumption can be improved by optimizing power saving settings, which promotes more efficient use of resources and extends battery life for portable devices.
...
"C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe"="~ WIN7RTM"
